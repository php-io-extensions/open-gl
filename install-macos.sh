...
# macOS installer for the OpenGL Zephir extension.
# - Verifies OpenGL.framework
...
header() {
    echo "=========================================="
    echo "OpenGL Extension Installer (macOS)"
    echo "=========================================="
    echo ""
}
...
ensure_opengl_macos() {
    step "🖼️  Verifying OpenGL.framework..."
    ...
    die "OpenGL.framework was not found. Expected on macOS."
}
...
if ! ./configure --enable-opengl >>"$LOG_FILE" 2>&1; then
    show_failure_logs
...
echo ""
echo "Demo (requires glfw extension for the window):"
echo "  php examples/proof_menu.php"
echo ""
echo "File locations:"
