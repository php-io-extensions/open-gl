...
# Debian Trixie / Raspberry Pi OS installer for the opengl PHP extension.
#
...
header() {
    echo "============================================"
    echo " OpenGL Extension Installer (Debian / Pi OS) "
    echo "============================================"
    echo ""
}
...
ensure_gl_dev() {
    step "📚 Checking OpenGL development packages..."
...
./configure --enable-opengl >>"$LOG_FILE" 2>&1 || { show_failure_logs; die "configure failed."; }
