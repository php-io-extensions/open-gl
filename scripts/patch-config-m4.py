#!/usr/bin/env python3
"""Rewrite ext/config.m4 for portable OpenGL linking (Darwin framework / Linux -lGL)."""
...
CONFIG = r"""PHP_ARG_ENABLE(opengl, whether to enable opengl, [ --enable-opengl   Enable Opengl])
